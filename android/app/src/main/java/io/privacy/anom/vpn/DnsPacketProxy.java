...
import io.privacy.anom.blocklist.BlockListDB;
...
public class DnsPacketProxy {
    ...
    final BlockListDB ruleDatabase;
    ...
    public DnsPacketProxy(EventLoop eventLoop, BlockListDB database) {
    ...
    public DnsPacketProxy(EventLoop eventLoop) {
        this.eventLoop = eventLoop;
        this.ruleDatabase = BlockListDB.getInstance();
    }
     ...
     * @throws AnomVPNThread.VpnNetworkException If some network error occurred
     */
    void handleDnsRequest(byte[] packetData) throws AnomVPNThread.VpnNetworkException {
    ...
    /**
     * Interface abstracting away {@link AnomVPNThread}.
     */
    interface EventLoop {
        /**
         ...
         */
        void forwardPacket(DatagramPacket packet, IpPacket requestPacket) throws AnomVPNThread.VpnNetworkException;
